...
parser.add_argument('--mongo_db', default='test', help='mongodb db to connect to')
parser.add_argument('--mongo_url', default='mongodb://localhost/test', help='mongodb url to connect to')
